...
export default function EditMachinistPage({ params }: { params: { id: string } }) {
  return (
      ...
      <header className="sticky top-0 z-10 border-b bg-background">
        <div className="container flex h-16 items-center justify-between py-4">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold">Editar Maquinista</h1>
          </div>
        </div>
      </header>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="dni" defaultValue="25789456" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="address" defaultValue="Av. Rivadavia 1234, CABA" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="phone">Teléfono</Label>
                <Input id="phone" defaultValue="1155667788" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" defaultValue="juan.perez@ferrocarriles.com" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2 border rounded-md p-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="formation-1" defaultChecked />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="formation-3" defaultChecked />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="formation-5" defaultChecked />
